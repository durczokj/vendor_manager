...
| "Cannot delete: this contract is used by an order." | An order still references this contract (per FR‑4). | Point the order at a different contract, or delete the order first. |
